...
public class UI_RestreamableChannels : MonoBehaviour
{
    ...
    public string m_periscope = "https://www.periscope.tv/EloiStree/";
    ...
    public void OpenDiscordLive()   { OpenWebPage(m_dlive); }
    public void OpenDLiveLive()     { OpenWebPage(m_discord); }
